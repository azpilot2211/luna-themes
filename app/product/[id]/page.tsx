...
export default async function ProductPage({params,}: {params: {id: string}}) {
    ...
    return(
        <section className="max-w-7xl mx-auto px-4 lg:px-8 lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16 mt-32">
            ...
            <div className="max-w-2xl mx-auto mt-5 lg:max-w-none lg:mt-5 lg:row-span-2 lg:row-end-2 lg:col-span-3">
                    <h1 className="text-2xl font-extrabold tracking-tight text-gray-900 sm:text-3xl">{data?.name}</h1>
                    <p className="mt-4 text-muted-foreground">{data?.smallDescription}</p>
                    ...
                    <div className="border-t border-gray-200 my-10 pt-10">
                        <div className="grid grid-cols-2 w-full gap-y-3">
                            ...
                            <h3 className="text-sm font-medium col-span-1">{new Intl.DateTimeFormat("en-US", {dateStyle: "long",}).format(data?.createdAt)}</h3>
            ...
            <div className="w-full max-w-2xl mx-auto mt-16 lg:max-w-none lg:mt-0 lg:col-span-4 mb-24">
